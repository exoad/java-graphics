...
public static class ComponentResizer extends MouseAdapter
{
	...
	private Dimension getBoundingSize(Component source)
	{
        ...
        private int titleHeight, pX = 0, pY = 0;
        private ComponentResizer cr;
        
        public TitledFrame(final String titleStr, final ImageIcon titleIMG, final int titleHeight, final JComponent content) {
            cr = new ComponentResizer();
        
            frame = new JFrame();
            frame.setUndecorated(titleHeight >= 0);
            frame.setTitle(titleStr);
            frame.setIconImage(titleIMG.getImage());
            frame.setPreferredSize(new Dimension(content.getPreferredSize().width, titleHeight + content.getPreferredSize().height));
            frame.setDefaultCloseOperation(WindowConstants.DISPOSE_ON_CLOSE);
            cr.registerComponent(frame);
            frame.addMouseListener(new ComponentResizer());
            ...
            titleBar.addComponentListener(new ComponentAdapter() {
                ...
                public void componentResized(ComponentEvent e) {
                    if(titleBar.getPreferredSize().height > titleHeight) {
                        titleBar.setPreferredSize(new Dimension(frame.getPreferredSize().width, titleHeight));
                    }
                }
            });
        ...
        private static JButton gen_Button(int size, Color color, Runnable func) {
            ...
            r.addActionListener(x -> func.run());
            return r;
        }
    ...
    public static void main(String ... args) throws Exception {
        ...
        jp.setPreferredSize(new Dimension(300, 500));
        jp.setOpaque(true);
        jp.setBackground(Color.RED);

        new TitledFrame("Amogus", new ImageIcon(), 25, jp).run();
    }
}